...
namespace Animation
{
    public class CheeseInventoryAnimation : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            endPos = startPos - new Vector3(0,height+padding,0);
        }
        public IEnumerator MoveInventory() // when the player buy a cheese trigger the animation for the animation
        {
        ...
        public void ToggleInv() // if the player press tab, toggle the inventory directly
        {
